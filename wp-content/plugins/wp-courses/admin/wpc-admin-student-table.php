...
<div class="wpc-admin-box-content">
	...
	<table class="widefat fixed" cellspacing="0">
		<thead>
			<tr>
				<th class="manage-column column-columnname" scope="col"><?php esc_html_e('Name', 'wp-courses'); ?></th>
			...
			<?php
				...
				foreach($users as $user) {
					...
					echo '<tr class="' . esc_attr($class) . '">';
						echo '<td class="column-columnname"><a href="?page=manage_students&student_id=' . (int) $user->ID . '"><strong>' . $user->display_name . '</strong></a></td>';
