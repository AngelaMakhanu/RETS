	...
	<div class="tutor-single-page-top-bar tutor-d-flex tutor-justify-content-between">
		<div class="tutor-topbar-left-item tutor-d-flex">
			<div class="tutor-topbar-item tutor-topbar-sidebar-toggle tutor-hide-sidebar-bar tutor-d-flex tutor-d-none tutor-d-xl-flex">
				<a href="javascript:;" class="tutor-lesson-sidebar-hide-bar flex-center">
					<span class="tutor-icon-icon-light-left-line color-text-white"></span>
				</a>
			</div>
			<div class="tutor-topbar-item tutor-topbar-content-title-wrap flex-center">
				<span class="tutor-icon-youtube-brand color-text-white tutor-mr-4"></span>
		...
		<div class="tutor-topbar-right-item tutor-d-flex">
			...
			<div class="tutor-topbar-cross-icon tutor-ml-16 flex-center">
				<a href="<?php echo esc_url( get_permalink( $course_id ) ); ?>">
					<span class="tutor-icon-line-cross-line color-text-white flex-center"></span>
				</a>
			</div>
		</div>
	</div>
