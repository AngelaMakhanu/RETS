					...
					<div class="tutor-course-topic tutor-zoom-meeting <?php echo esc_html( ( 0 === $index ) ? 'tutor-active' : '' ); ?>">
						<div class="tutor-course-title">
							<div class="tutor-zoom-meeting-detail">
								...
								<div>
									<p><?php esc_html_e( 'ID', 'tutor-pro' ); ?>: <span><?php echo $meeting_data['id']; ?></span> <i class="tutor-icon-copy-filled tutor-copy-text" data-text="<?php echo $meeting_data['id']; ?>"></i></p>
									<p><?php esc_html_e( 'Password', 'tutor-pro' ); ?>: <span><?php echo $meeting_data['password']; ?></span> <i class="tutor-icon-copy-filled tutor-copy-text" data-text="<?php echo $meeting_data['password']; ?>"></i></p>
								</div>
							</div>
							<div class="tutor-zoom-meeting-toggle-icon">
								<i class="tutor-icon-angle-right-filled"></i>
							</div>
						</div>
						<div class="tutor-course-lessons tutor-zoom-meeting-session" style="display: <?php echo ( $index == 0 ) ? 'block' : 'none'; ?>">
							<?php if ( $zoom_meeting->is_expired ) { ?>
								...
								<div class="session-link">
									...
									<a href="<?php echo esc_url( get_permalink( $meeting->ID ) ); ?>" class="tutor-btn bordered-btn"><?php esc_html_e( 'Continue to Meeting', 'tutor-pro' ); ?></a>
								</div>
								<?php
							}
							?>
