...
class QuizImportExport {
	...
	public function quiz_import_button_callback($topic_id){
		...
		<span class="tutor-import-quiz-button">
			...
			<button class="tutor-btn tutor-is-outline tutor-is-sm">
				<i class="tutor-icon-import-filled tutor-fs-6 tutor-mr-4"></i>
	...
	public function quiz_action_button_callback($quiz_id = ''){
		if($quiz_id){ ?>
			...
			<span class="tutor-color-muted tutor-icon-export-line tutor-fs-4 tutor-lh-1" area-hidden="true"></span>
			</a>
		<?php }
	}
