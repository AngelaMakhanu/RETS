...
<section class="tutor-backend-settings-page email-manage-page" style="margin-left: -20px;">
	<header class="header-wrapper tutor-px-32 tutor-py-24">
		...
		<div class="header-main tutor-d-flex flex-wrap  tutor-align-items-center tutor-justify-content-between">
			<div class="header-left">
				<h4 class="tutor-color-black tutor-d-flex tutor-align-items-center tutor-fs-4 tutor-fw-medium tutor-mt-4">
			...
			<div class="header-right d-inline-flex">
				<button class="tutor-btn tutor-is-default tutor-is-sm is-text-only" id="send_a_test_email" data-mailto="<?php echo esc_attr( $get_request['to'] ); ?>">
					<span class="tutor-icon-send-filled"></span>
					<span><?php _e("Send a Test Mail", "tutor-pro"); ?></span>
				</button>
				<button class="tutor-btn tutor-is-sm tutor-ml-0 tutor-ml-lg-8" form="email_template_form" id="email_template_save">Save Changes</button>
			</div>
		</div>
	</header>
	...
	<main class="main-content-wrapper">
		<div class="main-content content-left">
			<header class="tutor-mb-8">
				<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-2 tutor-d-flex  tutor-align-items-center">
			...
			<div class="content-form">
				<form method="POST" id="email_template_form">
					...
					<div class="tutor-option-field-input field-group tutor-mb-16">
						<label class="tutor-form-label tutor-d-flex tutor-align-items-center">
						...
						<input type="text" name="email-subject" value="<?php echo esc_html( $subject ); ?>" class="tutor-form-control" placeholder="<?php _e( 'Add the Email Subject', 'tutor-pro' ); ?>">
					</div>
					...
					<div class="tutor-option-field-input field-group tutor-mb-16">
						...
						<input type="text" name="email-heading" class="tutor-form-control" placeholder="<?php _e( 'Add an Email Heading', 'tutor-pro' ); ?>" value="<?php echo esc_html( $heading ); ?>">
					</div>

					<div class="tutor-option-field-input field-group tutor-mb-16">
						<label class="tutor-form-label tutor-d-flex  tutor-align-items-start">
		...
		<div class="main-content content-right">
			<header class="tutor-d-flex tutor-align-items-center tutor-justify-content-center flex-wrap tutor-mb-16">
				<div class="tutor-fs-5 tutor-fw-medium tutor-color-black"><?php _e("Template Preview", "tutor-pro"); ?></div>
			</header>

			<div class="template-preview position-relative" data-email_template="<?php echo esc_attr( $email_template ); ?>">
