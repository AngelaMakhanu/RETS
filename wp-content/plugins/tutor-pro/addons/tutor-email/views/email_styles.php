<style>
.tutor-email-body{font-weight:400;padding: 80px 20px 80px;color: #5B616F;background-color: #EFF1F6;line-height: 26px;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;margin-bottom: 20px;}
.email-manage-page .tutor-email-body{padding: 0;}
