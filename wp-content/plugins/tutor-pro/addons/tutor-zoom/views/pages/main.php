            ...
            <ul>
                <?php
                    ...
                    foreach ( $subPages as $key => $sub_page ) {
                        ...
                        $active =  $active_query_vars == $key ? 'is-active' : '' ;
                        ?>
                        <li class="<?php echo $active_query_vars == $key ? 'active' : '' ?>">
                            <a href="<?php echo esc_url( $sub_page['frontend_url'] ); ?>">
...
<div class="<?php echo is_admin() ? 'wrap' : ''; ?>">
        ...
        <?php
            ...
            <div class="tutor-app-process-alert tutor-mb-16">
                <div style="border:1px solid #1973aa;" class="tutor-primary tutor-py-12 tutor-px-4 tutor-radius-6">
                    <div class="tutor-alert-text tutor-d-flex tutor- tutor-align-items-center">
                        <span class="tutor-icon-circle-outline-info-filled tutor-mr-12 tutor-h4 tutor-color-brand-wordpress"></span>
