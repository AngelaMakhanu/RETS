...
?>
<?php if ( ! is_admin() ) : ?>
<div class="zoom-configure-wrapper tutor-d-flex tutor-align-items-center tutor-mt-36">
    <div class="tutor-zoom-icon-content-wrapper">
        <i class="tutor-icon-zoom" area-hidden="true"></i>
        <div class="zoom-content">
            ...
            <div class="tutor-fs-7 tutor-color-black-70">
                <?php 
                    $content = "Please set your API Credentials. Without valid credentials, Zoom integration will not work. Create credentials by following " . '<a href="https://marketplace.zoom.us/develop/create" target="_blank" style="color: #4569df">this link</a>' . ".";
    ...
    <div class="zoom-image">
        <img src="<?php echo esc_url( TUTOR_ZOOM()->url . '/assets/images/zoom-api-key-banner.svg', 'tutor-pro' ); ?>" alt="zoom-config">
    </div>
</div>
<?php endif; ?>
...
<div class="tutor-zoom-api-container">
    <form id="tutor-zoom-settings" action="">
        ...
        <div class="tutor-zoom-form-container <?php echo is_admin() ? 'tutor-p-20 tutor-p-xl-40' : 'tutor-pt-40'; ?>">
            <div class="tutor-row tutor-align-items-center tutor-gx-xl-5">
                <div class="tutor-col-lg-6 tutor-mb-32 tutor-mb-lg-0">
                    <div class="tutor-mb-32">
                        <div class="tutor-fs-5 tutor-fw-medium tutor-mb-0">
                            <?php esc_html_e( 'Setup your Zoom Integration', 'tutor-pro' ); ?>
                        </div>
                    ...
                    <div class="tutor-input-group tutor-mb-20">
                    ...
                    <div class="tutor-input-group tutor-mb-40">
