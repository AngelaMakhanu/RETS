<div class="tutor-attachments-wrap">
    <?php
        ...
        foreach ( $materials_array as $attachment ) {
            ...
            ?>
                <a href="<?php echo esc_url( ($content->alternateLink ? $content->alternateLink : $content->url) ); ?>" target="_blank" class="tutor-gc-material">
                    <div style="background-image:url(<?php echo esc_url( TUTOR_GC()->url . '/assets/images/attachment-icon.svg' ); ?>" data-thumbnail_url="<?php echo esc_url( $content->thumbnailUrl ); ?>" class="tutor-gc-google-thumbnail">
