...
class init{
	...
	public function tutor_gc_classes($attr=[]){
		...
		switch($column){
			...
			case 2 	: $column_class='col-xs-12 tutor-col-sm-6'; break;
			case 3 	: $column_class='col-xs-12 tutor-col-sm-6 tutor-col-md-4'; break;
			case 4 	: $column_class='col-xs-12 tutor-col-sm-6 tutor-col-md-4 tutor-col-lg-3'; break;
			case 6 	: $column_class='col-xs-12 tutor-col-sm-6 tutor-col-md-4 tutor-col-lg-3 tutor-col-xl-2'; break;
			default	: $column_class='col-xs-12 tutor-col-sm-6 tutor-col-md-4';
		}
