...
<div class="tutor-admin-page-wrapper  tutor-admin-enrollment-wrapper">
	...
	<div class="tutor-admin-page-content-wrapper tutor-mt-24 tutor-mr-20">
							...
							<tr>
								...
								<td data-th="<?php _e('Date', 'tutor-pro'); ?>">
									<div class="td-datetime tutor-fs-7 tutor-color-black">
										<?php esc_html_e( tutor_get_formated_date( get_option( 'date_format' ), $list->enrol_date ) ); ?>,
										<?php esc_html_e( tutor_get_formated_date( get_option( 'time_format' ), $list->enrol_date ) ); ?>
									</div>
								</td>
								<td data-th="<?php _e('Course', 'tutor-pro'); ?>">
									<div class="td-avatar">
										...
										<a
										href="<?php echo esc_url( get_permalink($list->course_id) ); ?>" class="btn-text btn-detail-link tutor-color-design-dark" target="_blank"
										>
	...
	<div class="tutor-admin-page-pagination-wrapper tutor-mt-12 tutor-mr-4">
		<?php
			/**
