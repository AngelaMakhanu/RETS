...
<div class="tutor-download-certificate tutor-pb-48 tutor-p-12">
    ...
    <div class="tutor-dc-certificate-details">
        <div class="tutor-certificate-info">
            <div class="tutor-info-id">
                <div class="tutor-info-id-name tutor-fs-7 tutor-color-black-60 tutor-pb-4">
            ...
            <div class="tutor-info-issued">
                <?php if ( '' !== $issued_by ) : ?>
                <div class="tutor-info-issued-name tutor-fs-7 tutor-color-black-60 tutor-pb-4">
            ...
            <div class="tutor-info-issued-date">
                <div class="tutor-info-date-name tutor-fs-7 tutor-color-black-60 tutor-pb-4">
    ...
    <div class="tutor-dc-button-group tutor-mt-72">
        <div class="tutor-dc-download-button">
            <button class="tutor-btn-circle tutor-is-outline tutor-m-8 tooltip-wrap">
                <span class="tutor-icon-import-filled"></span>
                <span style="top:10px" class="tooltip-txt tooltip-left tutor-d-flex">
                    <a class="tutor-certificate-pdf tutor-cert-view-page tutor-mr-8 tutor-d-flex tutor- tutor-align-items-center" style="text-decoration:none;color:#ffffff;" data-cert_hash="<?php echo esc_attr( $cert_hash ); ?>" data-course_id="<?php echo esc_attr( $course->ID ); ?>">
                        <span class="tutor-icon-pdf-file tutor-h5"></span> <span><?php esc_html_e( 'PDF', 'tutor-pro' ); ?></span>
                    </a>
                    <a href="#" class="tutor-d-flex tutor- tutor-align-items-center" id="tutor-pro-certificate-download-image" style="text-decoration:none;color:#ffffff;">
                        <span class="tutor-icon-jpg-file tutor-h5"></span> <span><?php esc_html_e( 'JPG', 'tutor-pro' ); ?></span>
                    </a>
                </span>
            </button>
        </div>
        <div class="tutor-dc-copy-button tutor-copy-text" data-text="<?php echo esc_url( $cert_url ); ?>">
            <button class="tutor-btn-circle tutor-is-outline tutor-m-8 tooltip-wrap">
                <span class="tutor-icon-copy-filled"></span>
                <span class="tooltip-txt tooltip-left"><?php esc_html_e( 'Copy Credential URL', 'tutor-pro' ); ?></span>
            </button>
        </div>
        <div class="tutor-dc-print-button" onClick="PrintDiv()">
            <button class="tutor-btn-circle tutor-is-outline tutor-m-8 tooltip-wrap">
                <span class="tutor-icon-print-filled"></span>
