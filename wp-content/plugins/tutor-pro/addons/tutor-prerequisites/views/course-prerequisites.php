<div id="tutor_prereq" class="<?php echo !is_single_course() ? 'tutor-quiz-wrapper tutor-quiz-wrapper tutor-d-flex tutor-justify-content-center tutor-mt-32 tutor-pb-80' : ''; ?>">
    ...
    <div class="course-prerequisites-lists-wrap">
        ...
        <ul class="prerequisites-course-lists">
            <li class="prerequisites-warning">
                <span>
                    <i class="tutor-icon-warning-f tutor-icon-24 tutor-color-warning"></i>
                </span>
                    ...
                    <li>
                        <a href="<?php echo get_the_permalink($courseID); ?>" class="prerequisites-course-item">
                            ...
                            <?php if (tutor_utils()->is_completed_course($courseID)){
                                ?>
                                <div class="is-complete-prerequisites-course"><i class="tutor-icon-mark-filled"></i></div>
                                <?php
                            } ?>
                        </a>
                    </li>
