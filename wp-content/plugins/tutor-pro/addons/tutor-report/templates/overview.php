...
<div class="tutor-analytics-overview">
	...
	<?php
		...
		$data          = array(
			...
			array(
				'icon'      => 'tutor-icon-add-member-filled',
	...
	<div class="tutor-table-responsive tutor-analytics-most-popular-courses tutor-mb-lg-50 tutor-mb-8">
		...
		<div class="tutor-ui-table-wrapper">
			<table class="tutor-ui-table tutor-ui-table-responsive table-popular-courses" style="--column-count: 3">
				<thead>
					<th>
					...
					<th class="tutor-table-rows-sorting">
						<div class="inline-flex-center tutor-fs-7 tutor-color-black-60">
							<span class="">
								<?php esc_html_e( 'Total Enrolled', 'tutor-pro' ); ?>
							</span>
							<span class="up-down-icon tutor-icon-order-down-filled tutor-icon-22"></span>
						</div>
					</th>
					<th class="tutor-table-rows-sorting">
						<div class="inline-flex-center tutor-fs-7 tutor-color-black-60">
	...
	<!--reviews-->
	<div class="tutor-ui-table-wrapper tutor-analytics-course-reviews">
		<?php
		...
		<table class="tutor-table- tutor-ui-table tutor-ui-table-responsive table-reviews" style="--column-count: 3">
			<thead>
				<th>
					<div class="tutor-fs-7 tutor-color-black-60">
				...
				if ( is_array( $reviews->results ) && count( $reviews->results ) ) :
					...
					<tr>
						<td data-th="<?php esc_html_e( 'Student', 'tutor-pro' ); ?>">
							<div class="td-avatar">
								<?php
									echo get_avatar( $review->user_id );
								?>
						...
						<!-- <td data-th="<?php _e( 'Feedback', 'tutor-pro' ); ?>">
							<div class="popular-course-rating">
								<?php tutor_utils()->star_rating_generator( $review->rating, true ); ?>
								<?php echo esc_html( number_format( $review->rating, 2 ) ); ?>
							</div>
							<div class="tutor-color-black-60 review-text">
						...
						<td data-th="<?php esc_html_e( 'Feedback', 'tutor-pro' ); ?>">
							<div class="td-feedback">
								...
								<div class="tutor-fs-6 tutor-color-black-60 tutor-mt-4">
