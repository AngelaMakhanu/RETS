...
<div class="tutor-analytics-statements">
	<div class="tutor-d-lg-flex tutor-justify-content-between">
	...
	<div class="statements-wrapper tutor-mt-24 tutor-mb-40">
		<div class="tutor-ui-table-wrapper">
			<table class="tutor-ui-table tutor-ui-table-responsive tutor-ui-table-analytics-statement">
				<thead>
					<th>
