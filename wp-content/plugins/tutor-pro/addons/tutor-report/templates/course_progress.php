...
$currentPost = $post;
$checked_icon = 'tutor-icon-mark-cricle';
?>
<style>
        i.tutor-done {
    ...
    i.tutor-icon-mark-filled:not(.tutor-done) {
        background-color: #3E64DE !important;
...
<div class="tutor-analytics-propress-popup">
    <div class="course-summary td-course-progress">
        ...
        <div class="course-info">
            ...
            <div class="course-total-completed course-progress tutor-d-flex tutor- tutor-align-items-center">
                <div class="progress-bar" style="--progress-value:<?php esc_attr_e( $_POST['total_progress'].'%;'); ?>">
                    <div class="progress-value"></div> </div>
                    <div class="tutor-color-black progress-text tutor-fs-7 tutor-fw-medium">
                                        ...
                                        foreach( $lessons->posts as $post) {
                                            ...
                                            if ($post->post_type === 'tutor_quiz') {
                                                ...
                                                ?>
                                                    ...
                                                    <li class="tutor-single-lesson-items tutor-border-top-0 quiz-single-item quiz-single-item-<?php echo $quiz->ID; ?> <?php echo ( $currentPost->ID === get_the_ID() ) ? 'active' : ''; ?>" data-quiz-id="<?php echo $quiz->ID; ?>">
                                                        <div>
                                                            <span class="tutor-icon-question-mark-circle-filled tutor-icon-24 tutor-color-black-30 tutor-mr-16"></span>
                                                ...
                                                ?>
                                                <li class="tutor-single-lesson-items tutor-border-top-0 assignments-single-item assignment-single-item-<?php echo $post->ID; ?> <?php echo ( $currentPost->ID === get_the_ID() ) ? 'active' : ''; ?>" data-assignment-id="<?php echo $post->ID; ?>">
                                                    <div>
                                                        <span class="tutor-icon-clipboard-line tutor-icon-24 tutor-color-black-30 tutor-mr-16"></span>
                                                        <span class="tutor-fs-6 tutor-color-black">
                                                ...
                                                <li class="tutor-single-lesson-items tutor-border-top-0 zoom-meeting-single-item zoom-meeting-single-item-<?php echo $post->ID; ?> <?php echo ( $currentPost->ID === get_the_ID() ) ? 'active' : ''; ?>>" data-assignment-id="<?php echo $post->ID; ?>">
                                                    <div>
                                                        <span class="tutor-icon-zoom tutor-icon-24 tutor-color-black-30 tutor-mr-16"></span>
                                                        <span class="tutor-fs-6 tutor-color-black">
                                                ...
                                                <li class="tutor-single-lesson-items tutor-border-top-0 <?php echo ( $post->ID ) ? 'active' : ''; ?>" data-assignment-id="<?php echo $post->ID; ?>">
                                                    <div>
                                                        <?php
                                                        $tutor_lesson_type_icon = $play_time ? 'youtube' : 'clipboard-line';
                                                        echo "<span class='tutor-icon-$tutor_lesson_type_icon tutor-icon-24 tutor-color-black-30 tutor-mr-16'></span>";
                                                        ?>
                                                        <span class="tutor-fs-6 tutor-color-black">
...
<style>
    .tutor-courses-lession-list li{border-top:none}
    .analytics-student-details + .modal-course-overview .tutor-modal-body{ overflow-x: hidden}
</style>