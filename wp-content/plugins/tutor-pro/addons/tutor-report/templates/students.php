						...
						<?php foreach ( $students['students'] as $student ) : ?>
							<tr>
								...
								<td data-th="<?php _e( '-', 'tutor-pro' ); ?>" class="td-action-btns">
									<a href="<?php echo esc_url( tutor_utils()->tutor_dashboard_url() . "analytics/student-details?student_id=$student->ID" ); ?>" class="tutor-btn tutor-btn-disable-outline tutor-btn-outline-fd tutor-btn-sm">
