...
<div class="tutor-admin-page-wrapper" id="tutor-report-courses-wrap">
	...
	<div class="tutor-report-courses-data-table tutor-mt-24 tutor-mr-20">
							...
							<tr>
								...
								<td data-th="<?php esc_attr_e( 'URL', 'tutor-pro' ); ?>" class="url">
									<div class="inline-flex-center td-action-btns">
										<a href="<?php echo esc_url( admin_url( 'admin.php?page=tutor_report&sub_page=courses&course_id=' . $course->ID ) ); ?>" class="btn-outline tutor-btn tutor-brand">
											Details
										</a>
										<a href="<?php echo esc_url( get_permalink( $course->course_id ) ); ?>" class="btn-text" target="_blank">
	...
	<div class="tutor-admin-page-pagination-wrapperp tutor-mt-12 tutor-mr-4">
		<?php
		/**
