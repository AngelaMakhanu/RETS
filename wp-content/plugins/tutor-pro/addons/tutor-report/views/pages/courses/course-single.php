...
<div id="tutor-report-courses-details-wrap" class="tutor-pr-20">
	<div class="tutor-course-report-header">
		<div class="tutor-course-report-header-left">
			...
			<div class="tutor-course-report-header-meta tutor-d-flex flex-wrap  tutor-align-items-center">
				<div class="tutor-course-report-created-date tutor-fs-7 tutor-color-black-60">
					<span><?php esc_html_e( 'Created', 'tutor-pro' ); ?></span>:
					<?php echo esc_html( get_the_date( get_option( 'date_format' ), $current_id ) ); ?>
				</div>
				<div
					class="tutor-course-report-last-update-date tutor-d-flex  tutor-align-items-center tutor-fs-7 tutor-color-black-60">
					<span class="tutor-icon-refresh-1-filled"></span>
		...
		<div class="tutor-course-report-header-right tutor-course-report-header-right tutor-d-flex  tutor-align-items-end tutor-justify-content-end">
			<a href="<?php echo esc_url( get_edit_post_link( $current_id ) ); ?>" class="tutor-btn tutor-btn-wordpress-outline tutor-btn-sm tutor-mr-16" target="_blank">
				<?php esc_html_e( 'Edit with Builder', 'tutor-pro' ); ?>
			</a>
			<a href="<?php echo esc_url( the_permalink( $current_id ) ); ?>" class="tutor-btn tutor-btn-wordpress tutor-btn-sm" target="_blank">
	...
	<div id="tutor-course-report-stats">
		<div class="tutor-course-report-single-stats">
			<div class="tutor-fs-6 tutor-fw-bold tutor-color-black tutor-course-report-single-stats-number">
				<?php
					$info_lesson = tutor_utils()->get_lesson_count_by_course( $current_id );
					echo esc_html( $info_lesson );
				?>
			</div>
			<div class="tutor-fs-7 tutor-color-black-60 tutor-course-report-single-stats-text">
				<?php esc_html_e( 'Lesson', 'tutor-pro' ); ?>
			</div>
		</div> <!-- tutor-course-report-single-stats -->
		<div class="tutor-course-report-single-stats">
			<div class="tutor-fs-6 tutor-fw-bold tutor-color-black tutor-course-report-single-stats-number">
			<?php
				$info_quiz = '';
		...
		<div class="tutor-course-report-single-stats tutor-ratings-stats">
			<div class="tutor-rattings-text tutor-fs-7 tutor-color-black-60 tutor-mt-4">
				<?php
	...
	<div id="tutor-course-details-student-list" class="tutor-mb-48">
							...
							<tr>
									...
									<?php echo get_avatar( $user_info->ID, 50 ); ?>
										<div class="td-avatar-detials">
											<div class="td-avatar-name tutor-d-flex">
												<p class="tutor-color-black tutor-fs-6 tutor-fw-medium">
													<?php echo esc_html( $user_info->display_name ); ?>
												</p>
												<a href="<?php echo esc_url( tutor_utils()->profile_url( $user_info->ID, true ) ); ?>" class="tutor-ml-12 tutor-d-flex">
													<span class="tutor-icon-detail-link-filled tutor-color-black"></span>
												</a>
											</div>
											<p class="tutor-color-black-70 tutor-fs-7">
								...
								<td data-th="<?php esc_html_e( 'Enroll Date', 'tutor-pro' ); ?>">
									<span class="tutor-color-black tutor-fs-7">
										<?php echo esc_html( tutor_get_formated_date( get_option( 'date_format' ), $student->post_date ) ); ?>
									</span>
								</td>
								...
								<td data-th="<?php esc_html_e( 'Progress', 'tutor-pro' ); ?>">
									...
									<div class="td-progress inline-flex-center">
										<div class="progress-bar" style="--progress-value:<?php echo esc_attr( $percentage ); ?>%;">
								...
								<td data-th="<?php esc_html_e( 'Details', 'tutor-pro' ); ?>">
									<div class="inline-flex-center td-action-btns">
										<a href="<?php echo esc_url( admin_url( 'admin.php?page=tutor_report&sub_page=students&student_id=' . $user_info->ID ) ); ?>" class="btn-outline tutor-btn tutor-brand" target="_blank">
		...
		</div> <!-- tutor-course-details-student-list-table -->
		...
		<?php
			...
			?>
	</div> <!-- tutor-course-details-student-list -->
	...
	<div id="tutor-course-details-instructor-list" class="tutor-mb-48">
						...
						<?php foreach ( $instructors as $instructor ) : ?>
							...
							<tr>
								<td class="teacher" data-th="<?php esc_html_e( 'Teacher', 'tutor-pro' ); ?>">
									<div class="td-avatar">
										<?php echo get_avatar( $instructor->ID, 50 ); ?>
										<div class="td-avatar-detials">
											<div class="td-avatar-name tutor-d-flex">
												<p class="tutor-color-black tutor-fs-6 tutor-fw-medium">
													<?php
												...
												<?php if ( $crown ) : ?>
													<a class="tutor-ml-4 tutor-d-flex">
														<span class="tutor-icon-crown-filled tutor-color-design-warning"></span>
													</a>
												<?php endif; ?>
											</div>
											<p class="tutor-color-black-70 tutor-fs-7">
								...
								<td class="action-btns">
									<div class="inline-flex-center td-action-btns">
										<a href="<?php echo esc_url( tutor_utils()->profile_url( $instructor->ID, true ) ); ?>" class="btn-outline tutor-btn tutor-brand" target="_blank">
											View Profile
										</a>
									</div>
								</td>
		...
		</div> <!-- tutor-course-details-instructor-list-table -->
	</div> <!-- tutor-course-details-student-list -->
	...
	<div id="tutor-course-details-review-section" class="tutor-mb-48">
		...
		<div class="tutor-ui-table-wrapper tutor-mb-48">
			<table class="tutor-ui-table tutor-ui-table-responsive"  id="tutor-admin-reviews-table">
				<thead>
					<tr>
						<th class="tutor-table-rows-sorting">
						...
						<tr>
							<td data-th="<?php esc_html_e( 'Student', 'tutor-pro' ); ?>" class="student">
								<div class="td-avatar">
									...
									<a href="<?php echo esc_url( tutor_utils()->profile_url( $review->user_id, false ) ); ?>" class="tutor-d-flex" target="_blank">
										<span class="tutor-icon-detail-link-filled tutor-color-black"></span>
									</a>
								</div>
							</td>
								...
								<div class="td-feedback">
									<div class="td-tutor-rating tutor-fs-6 tutor-color-black-60">
										<div class="tutor-ratings">
											...
											<div class="tutor-rating-text tutor-ml-12">
							...
							<td data-th="<?php esc_html_e( 'Action', 'tutor-pro' ); ?>" class="review-action-btns text-align-center">
								<div class="inline-flex-center td-action-btns">
									<a class="btn-outline tutor-btn tutor-danger tutor-delete-recent-reviews" data-id="<?php echo esc_attr( $review->comment_ID ); ?>">
		...
		?>
	</div> <!-- tutor-courses-review-section -->
</div>