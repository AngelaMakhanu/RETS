...
class init {
	...
	public function required_version_notice() {
		?>
		<div class="notice notice-error tutor-install-notice" style="display:flex; tutor-justify-content: space-between; align-items: center;">
			...
			<div class="tutor-install-notice-button">
				<a class="button button-primary" href="https://github.com/themeum/tutor/releases/tag/v2.0.0-beta" target="_blank">
